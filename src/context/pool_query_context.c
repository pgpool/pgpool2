...
pool_virtual_master_db_node_id(void)
{
	...
	{
		/*
		 * We used to return REAL_MASTER_NODE_ID here.  Problem with it is, it
		 * is possible that REAL_MASTER_NODE_ID could be changed
		 * anytime. Suppose REAL_MASTER_NODE_ID == my_main_node_id == 1. Then
		 * due to failback, REAL_MASTER_NODE_ID is changed to 0. Then
